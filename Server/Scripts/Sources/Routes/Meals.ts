...
{
    const meals = require("express").Router(), db = require("../Mongodb"), parser = require("body-parser");
    meals.use(parser.json())
        .use(parser.urlencoded({ extended: true }))
        .get("/", (req, res) => db.Meals.ReadAll(response => res.json(response)))
